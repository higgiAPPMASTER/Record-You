export interface ChordDiagram {
  ...
  root: string;
  quality: string;
  positions: number[]; // [low E, A, D, G, B, high E], 0=open, -1=muted
  fingers: number[];   // 1-4 finger numbers, 0=open/no finger
  barre?: { fret: number; from: number; to: number }; // string indices (0=low E)
  baseFret: number;
}

export const ROOTS = ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"];
export const QUALITIES = ["major", "minor", "7", "maj7", "m7", "sus2", "sus4", "add9", "dim", "aug", "power", "m9", "9", "11", "13"];
...
export const CHORDS: ChordDiagram[] = [
  ...
  { name: "D9",    full: "D9",    root: "D",  quality: "9",     positions: [-1,5,4,5,5,5], fingers: [0,1,1,2,3,4], barre: { fret: 5, from: 1, to: 5 }, baseFret: 4 },
  ...
  { name: "G9",    full: "G9",    root: "G",  quality: "9",     positions: [3,2,0,2,0,1], fingers: [3,2,0,4,0,1], baseFret: 1 },
  ...
  { name: "A9",    full: "A9",    root: "A",  quality: "9",     positions: [-1,0,2,4,2,3], fingers: [0,0,1,3,1,2], baseFret: 1 },
  { name: "A11",   full: "A11",   root: "A",  quality: "11",    positions: [-1,0,0,0,3,3], fingers: [0,0,0,0,3,4], baseFret: 1 },
  ...
  { name: "B5",    full: "B5",    root: "B",  quality: "power", positions: [-1,2,4,4,-1,-1], fingers: [0,1,3,4,0,0], baseFret: 1 },
  ...
  { name: "C5",    full: "C5",    root: "C",  quality: "power", positions: [-1,3,5,5,-1,-1], fingers: [0,1,3,4,0,0], baseFret: 3 },
  { name: "D5",    full: "D5",    root: "D",  quality: "power", positions: [-1,-1,0,2,3,-1], fingers: [0,0,0,1,3,0], baseFret: 1 },
];
